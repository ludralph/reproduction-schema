-- CreateEnum
CREATE TYPE "status_type" AS ENUM ('CONFIGURING', 'READY', 'REQUESTED', 'PENDING', 'IN_PROGRESS', 'STOPPING', 'TERMINATED', 'ERROR', 'ERROR_DURING_DELETE');

-- CreateTable
CREATE TABLE "ab_email_domain" (
    "id" SERIAL NOT NULL,
    "domain" TEXT NOT NULL,
    "props" JSONB NOT NULL DEFAULT '{}',
    "groups" JSONB NOT NULL DEFAULT '{}',

    CONSTRAINT "pk_ab_email_domain" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "databasechangelog_abinitio_e" (
    "id" VARCHAR(255) NOT NULL,
    "author" VARCHAR(255) NOT NULL,
    "filename" VARCHAR(255) NOT NULL,
    "dateexecuted" TIMESTAMP(6) NOT NULL,
...
-- CreateTable
CREATE TABLE "ab_camp_user" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "user_id" VARCHAR(36) NOT NULL,
    "tokens" INTEGER DEFAULT 0,
    "gatekeeper_for" VARCHAR(36),
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "ab_camp_user_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "ab_training_env" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    ...
    CONSTRAINT "ab_training_env_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "ab_camp_audit" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "user_id" VARCHAR(36),
    "operation_id" VARCHAR(255) NOT NULL,
    "auditable_id" VARCHAR(36),
    "details" JSONB,

    CONSTRAINT "ab_camp_audit_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE UNIQUE INDEX "ab_email_domain_domain_key" ON "ab_email_domain"("domain");
...
-- CreateIndex
CREATE UNIQUE INDEX "uk_8aelwnibji49avxsrtuf6xjow" ON "client_default_roles"("role_id");

-- CreateIndex
CREATE INDEX "idx_client_def_roles_client" ON "client_default_roles"("client_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "uk_h4wpd7w4hsoolni3h0sw7btje" ON "realm_default_roles"("role_id");

-- CreateIndex
CREATE INDEX "idx_realm_def_roles_realm" ON "realm_default_roles"("realm_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "ab_camp_user_user_id_unique" ON "ab_camp_user"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "ab_camp_user_id_user_id_unique" ON "ab_camp_user"("id", "user_id");

-- CreateIndex
CREATE UNIQUE INDEX "ab_training_env_job_id_unique" ON "ab_training_env"("job_id");

-- CreateIndex
CREATE UNIQUE INDEX "ab_training_env_instance_id_unique" ON "ab_training_env"("instance_id");
...
-- AddForeignKey
ALTER TABLE "client" ADD CONSTRAINT "fk_p56ctinxxb9gsk57fo49f9tac" FOREIGN KEY ("realm_id") REFERENCES "realm"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "client_default_roles" ADD CONSTRAINT "fk_nuilts7klwqw2h8m2b5joytky" FOREIGN KEY ("client_id") REFERENCES "client"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "client_scope" ADD CONSTRAINT "fk_realm_cli_scope" FOREIGN KEY ("realm_id") REFERENCES "realm"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "client_scope_client" ADD CONSTRAINT "fk_c_cli_scope_client" FOREIGN KEY ("client_id") REFERENCES "client"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "client_scope_client" ADD CONSTRAINT "fk_c_cli_scope_scope" FOREIGN KEY ("scope_id") REFERENCES "client_scope"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "default_client_scope" ADD CONSTRAINT "fk_r_def_cli_scope_scope" FOREIGN KEY ("scope_id") REFERENCES "client_scope"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "keycloak_group" ADD CONSTRAINT "fk_group_realm" FOREIGN KEY ("realm_id") REFERENCES "realm"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "realm_default_roles" ADD CONSTRAINT "fk_evudb1ppw84oxfax2drs03icc" FOREIGN KEY ("realm_id") REFERENCES "realm"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "ab_camp_user" ADD CONSTRAINT "ab_camp_user_gatekeeper_for_foreign" FOREIGN KEY ("gatekeeper_for") REFERENCES "keycloak_group"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "ab_camp_user" ADD CONSTRAINT "ab_camp_user_user_id_foreign" FOREIGN KEY ("user_id") REFERENCES "user_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
